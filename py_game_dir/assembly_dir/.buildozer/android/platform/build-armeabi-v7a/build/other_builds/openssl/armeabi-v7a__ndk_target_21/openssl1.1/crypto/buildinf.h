...
#define DATE "built on: Sat Oct 16 01:18:59 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','l','o','c','k',
    '/','D','o','c','u','m','e','n','t','s','/','p','y','d','i','r',
    '/','p','y','_','g','a','m','e','_','d','i','r','/','a','s','s',
    'e','m','b','l','y','_','d','i','r','/','.','b','u','i','l','d',
